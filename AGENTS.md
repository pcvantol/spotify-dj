...
- Actuele integratieversie: `2.9.24`.
...
- Options-flow bevat een actie-keuze voor instellingen opslaan of SpotifyDJ device opnieuw koppelen; re-pair maakt een nieuw device token, bewaart dat persistent en probeert `/api/device/pair` opnieuw.
