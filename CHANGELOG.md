...
- Keep the integration domain on `djconnect` and publish the clean `v3.0.3` release line after removing older release/tag history from the renamed repository.
...
- Refresh README, website, examples, diagnostics metadata, handoff notes, ESP synchronization prompt and tests for the DJConnect 3.0.3 architecture.
