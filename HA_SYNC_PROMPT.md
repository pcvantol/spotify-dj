...
Synchroniseer de Home Assistant integration met de actuele DJConnect ESP firmware contracten voor release `v3.0.2`.
...
- Current HA integration release/tag baseline is `v3.0.2`; do not reference old 2.x firmware assets or tags.
...
{
  "version": "3.0.2",
  "url": "https://github.com/pcvantol/djconnect-firmware/releases/download/v3.0.2/djconnect-device-v3.0.2.bin",
  "sha256": "...",
...
- ESP `v3.0.2` pairs without stale-pairing loops.
