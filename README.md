...
- Home Assistant integration: `2.9.22`
- Domain: `spotify_dj`
...
```json
{
  ...
  "asset": "spotifydj-device-v2.9.22.bin",
  "sha256": "0123456789abcdef0123456789abcdef0123456789abcdef0123456789abcdef",
  "size": 2113136,
  "min_ha_integration": "2.9.22"
}
```
...
```bash
git add .
git commit -m "Release SpotifyDJ v2.9.22"
git tag v2.9.22
git push origin main
git push origin v2.9.22
gh release create v2.9.22 --title "SpotifyDJ v2.9.22" --notes-file CHANGELOG.md
```
...
- If the pairing token is stale, open SpotifyDJ options and choose `Re-pair SpotifyDJ device` from the action selector.
