...
- Home Assistant integration: `3.0.27`
- Domain: `djconnect`
...
```bash
git add .
git commit -m "Release DJConnect v3.0.27"
git tag v3.0.27
git push origin main
git push origin v3.0.27
gh release create v3.0.27 --title "DJConnect v3.0.27" --notes-file CHANGELOG.md
```
