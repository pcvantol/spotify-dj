...
- Home Assistant integration: `3.0.2`
- Domain: `djconnect`
...
```bash
git add .
git commit -m "Release DJConnect v3.0.2"
git tag v3.0.2
git push origin main
git push origin v3.0.2
gh release create v3.0.2 --title "DJConnect v3.0.2" --notes-file CHANGELOG.md
```
