...
- Home Assistant integration: `2.9.10`
- Domain: `spotify_dj`
...
```json
{
  ...
  "asset": "spotifydj-device-v2.9.10.bin",
  "sha256": "0123456789abcdef0123456789abcdef0123456789abcdef0123456789abcdef",
  "size": 2113136,
  "min_ha_integration": "2.9.10"
}
```
...
```bash
git add .
git commit -m "Release SpotifyDJ v2.9.10"
git tag v2.9.10
git push origin main
git push origin v2.9.10
gh release create v2.9.10 --title "SpotifyDJ v2.9.10" --notes-file CHANGELOG.md
```
