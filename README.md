...
- Home Assistant integration: `3.0.31`
- Domain: `djconnect`
...
```json
{
  ...
  "asset": "djconnect-device-v3.0.31.bin",
  "sha256": "0123456789abcdef0123456789abcdef0123456789abcdef0123456789abcdef",
  "size": 2113136,
  "min_ha_integration": "3.0.31"
}
```
...
```bash
git add .
git commit -m "Release DJConnect v3.0.31"
git tag v3.0.31
git push origin main
git push origin v3.0.31
gh release create v3.0.31 --title "DJConnect v3.0.31" --notes-file CHANGELOG.md
```
