...
- Home Assistant integration: `3.0.5`
- Domain: `djconnect`
...
```bash
git add .
git commit -m "Release DJConnect v3.0.5"
git tag v3.0.5
git push origin main
git push origin v3.0.5
gh release create v3.0.5 --title "DJConnect v3.0.5" --notes-file CHANGELOG.md
```
