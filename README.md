...
- Home Assistant integration: `3.0.40`
- Domain: `djconnect`
...
```bash
git add .
git commit -m "Release DJConnect v3.0.40"
git tag v3.0.40
git push origin main
git push origin v3.0.40
gh release create v3.0.40 --title "DJConnect v3.0.40" --notes-file CHANGELOG.md
```
