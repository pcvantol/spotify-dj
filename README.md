...
- Home Assistant integration: `3.0.8`
- Domain: `djconnect`
...
```json
{
  ...
  "asset": "djconnect-device-v3.0.8.bin",
  "sha256": "0123456789abcdef0123456789abcdef0123456789abcdef0123456789abcdef",
  "size": 2113136,
  "min_ha_integration": "3.0.8"
}
```
...
```bash
./release.sh 3.0.7 --publish-firmware-repo ../djconnect-firmware
```
...
```bash
git add .
git commit -m "Release DJConnect v3.0.8"
git tag v3.0.8
git push origin main
git push origin v3.0.8
gh release create v3.0.8 --title "DJConnect v3.0.8" --notes-file CHANGELOG.md
```
